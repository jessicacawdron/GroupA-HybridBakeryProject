...
INSERT INTO customer(first_name, last_name, email, pass_word, phone_number, home_address_id, billing_address_id) VALUES ('Connor', 'Larkin', 'CLarkin@email.com', 'password3',  '07356673985', 2, 2), ('Sally','Long', 'SallyL@email.co.uk', 'password4', '074982762892',3,3), ('James','Ellis', 'JamesEllis@email.com','07345786211');